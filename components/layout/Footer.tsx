          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/65">
              ...
              <li className="flex flex-col sm:flex-row sm:gap-4">
                <a href={`tel:${contact.phone.primary}`} className="hover:text-white transition-colors">
                  {contact.phone.primary}
                </a>
                <a href={`tel:${contact.phone.secondary}`} className="hover:text-white transition-colors">
