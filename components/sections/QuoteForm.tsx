...
export function QuoteForm({
    ...
    async function handleSubmit() {
        ...
        // TODO: Replace with actual submission (Formspree, Resend, or server action)
            ...
            {step === 3 && (
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full px-4 py-3 rounded-lg border border-gray-light focus:border-amber focus:ring-2 focus:ring-amber/20 outline-none transition-colors text-charcoal" placeholder="+234 800 000 0000" />
